...
if res ~= 200 then
print('\27[0;31m⊶──────────≺𝐗𝐗𝐗≻───────────⊷ ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⊶──────────≺𝐗𝐗𝐗≻───────────⊷ ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m⊶──────────≺𝐗𝐗𝐗≻───────────⊷ ٴ \n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/XxX-TEAM/Files_XxX/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1573309498,1069625450,1755674443}   
...
var = true  
elseif tonumber(user_id) == tonumber(1755674443) then
var = true  
...
function plugin_XxX(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.XxX and msg then
pre_msg = plugin.XxX(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceXxX(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,XxX_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/XxX/main/XxX.lua')
...
-------------
if text == "◑ تحديثات سورس اكس ◑" and Devmode(msg) then  
local updatech =[[
...
send(msg.chat_id_, msg.id_,'≉︙ عدد الكروبات الان ↫ { '..#group..' }'..XxXk..''..XxX..'\n≉︙ الان عدد الكروبات الحقيقي ↫ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local XxX1_Msg = database:get(bot_id.."XxX1:Add:Filter:Rp2"..text..msg.chat_id_)   
if XxX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ≉︙العضو ↫ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'LaRiCaTeam')..') \n ≉︙'..XxX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if XxX_Msg and not Special(msg) then  
local XxX_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if XxX_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ≉︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ≉︙["..XxX_Msg.."] \n")
else
send(msg.chat_id_,0," ≉︙العضو : {["..data.first_name_.."](T.ME/LaRiCaTeam)}\n ≉︙["..XxX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ≉︙عذرا ↫ {["..data.first_name_.."](T.ME/LaRiCaTeam)}\n ≉︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."XxX:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."XxX:blocname"..msg.chat_id_)
...
if name_MRmode then 
names_MRmode = database:smembers(bot_id.."XxX:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."XxX:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."XxX:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."XxX:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."XxX:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."XxX:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function mode_mrmode_new(mrmode1,mrmode2)
if mrmode2 and mrmode2.first_name_ then 
if mrmode2.first_name_:match("(.*)"..database:get(bot_id.."XxX:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."XxX:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrmode_nnn = database:get(bot_id.."XxX:nump"..msg.chat_id_) or 5
local mrmode_nnn2 = database:get(bot_id.."XxX:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrmode_nnn2) == tonumber(mrmode_nnn) or tonumber(mrmode_nnn2) > tonumber(mrmode_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."XxX:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "≉︙عزيزي >>["..mrmode2.username_.."](https://t.me/"..(mrmode2.username_ or "LaRiCaTeam")..")\n≉︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."XxX:teh"..msg.chat_id_).."} بجانب اسمك\n≉︙عدد المحاولات المتبقيه {"..(tonumber(mrmode_nnn) - tonumber(mrmode_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..XxXChengName..']')
...
Text = "ᴡᴇʟᴄᴏᴍᴇ sɴᴀᴘ sᴏᴜʀᴄᴇ ✷\n\n[𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝙎𝙣𝙖𝙥 💥](http://t.me/LaRiCaTeam)\n\n[𝙄𝙣𝙁𝙤 𝙎𝙤𝙪𝙧𝙘𝙚](http://t.me/BBI9B)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور اكس 🇮🇶 .',url="https://t.me/BBBBRR"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ≉︙بواسطه ↫ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'LaRiCaTeam')..') \n ≉︙تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devmode(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/XxX-TEAM/Files_XxX/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ≉︙اهلا بك في متجر ملفات اكس\n ≉︙ملفات السورس ⇟\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n\n"
local TextE = "\n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n ≉︙علامة تعني { ✔️ } ملف مفعل\n ≉︙علامة تعني { ✖ } ملف معطل\n ≉︙قناة سورس اكس ⇟\n".." ≉︙[اضغط هنا لدخول](t.me/LaRiCaTeam) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/XxX-TEAM/Files_XxX/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "XxX-TEAM")
...
function Function_XxX(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_XxX, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_XxX, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ≉︙لعضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'LaRiCaTeam')..')'
status  = '\n ≉︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ≉︙العضو ↫ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ≉︙العضــو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'LaRiCaTeam')..')'
...
database:set(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ≉︙ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."XxX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."XxX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ≉︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."XxX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."XxX1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."XxX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ≉︙ارسل الكلمه الان")  
database:set(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."XxX1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."XxX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."XxX1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."XxX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."XxX1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."XxX1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ≉︙قائمة المنع \n⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆\n"
for k,v in pairs(list) do  
local XxX_Msg = database:get(bot_id.."XxX1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ↫ {"..XxX_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..XxX_Msg[math.random(#XxX_Msg)]..']') 
return false
end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ≉︙ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:XxX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:XxX:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:XxX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"≉︙تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:XxX:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:XxX:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:XxX:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:XxX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:XxX:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:XxX:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:XxX:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:XxX:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:XxX:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:XxX:List:Rd:Sudo")
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 𝚂𝙽𝙰𝙿 ᴛᴇᴀᴍ .',url="t.me/LaRiCaTeam"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."LaRiCaTeam:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'◑ تم تفعيل الانستا')
database:set(bot_id.."LaRiCaTeam:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."LaRiCaTeam:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."LaRiCaTeam:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"≉︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."LaRiCaTeam:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."LaRiCaTeam:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس اكس يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:XxX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"≉︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:XxX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:XxX:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:XxX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:XxX:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:XxX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:XxX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:XxX:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:XxX:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:XxX:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:XxX:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'اكس').." غادر" or text == 'بوت غادر' then  
...
-- vardump(data) 
XxXdx(msg.chat_id_, msg.id_, ' ≉︙ايدي المجموعة ↫ ( '..msg.chat_id_..' )\n ≉︙عدد الادمنيه ↫ ( *'..data.administrator_count_..' )*\n ≉︙عدد المحظورين ↫ ( *'..data.kicked_count_..' )*\n ≉︙عدد الاعضاء ↫ ( *'..data.member_count_..' )*\n', 'md') 
end 
...
⋆ ┉  ┉  ┉  ┉S𝗡𝗣 ┉  ┉  ┉  ┉ ⋆
 ...
 ◑ رابط حذف [Snspchat](https://accounts.XxXchat.com/accounts/login?continue=https%3A%2F%2Faccounts.XxXchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
XxX = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(XxX)
...
--------------------------------------------------------------------------------------------------------------
SourceXxX(data.message_,data)
plugin_XxX(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local XxXAbot = database:get(bot_id.."XxX1:Add:Filter:Rp2"..text..result.chat_id_)   
if XxXAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ≉︙العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ≉︙["..XxXAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local XxX1_Msg = database:get(bot_id.."XxX1:Add:Filter:Rp2"..text..result.chat_id_)   
if XxX1_Msg then    
send(msg.chat_id_, msg.id_," ≉︙"..XxX1_Msg)
