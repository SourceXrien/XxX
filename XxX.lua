...
if hash or Bot(msg) or DevXxX(msg) or DevBotsIs(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevXxX(msg) or DevBot(msg) or DevBotsIs(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevXxX(msg) or DevBot(msg) or DevBotsIs(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevXxX(msg) or DevBot(msg) or BasicConstructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevXxX(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevXxX(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevXxX(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevXxXe(user_id) == true then
var = true
elseif DevXxX(user_id) == true then
var = true
...
elseif DevXxXe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
function XxX_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local XxX_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if XxX_Msg then    
...
if text == ("الثانويين") and DevXxX(msg) then
...
if text == ("مسح قائمه العام") and DevXxX(msg) then
database:del(bot_id.."GBan:User")
database:del(bot_id.."GMuted:User")
send(msg.chat_id_, msg.id_, "\n✫: تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevXxX(msg) then
...
if text == ("قائمه العام") and DevXxX(msg) then
...
if text == ("قائمه كتم عام") and DevXxX(msg) then
...
if text == ("المطورين") and DevXxX(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXxX(msg) then
function Function_XxX(extra, result, success)
...
if text and text:match("^حظر عام @(.*)$")  and DevXxX(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevXxX(msg) then
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXxX(msg) then
function Function_XxX(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "✫: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevXxX(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevXxX(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXxX(msg) then
function Function_XxX(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevXxX(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevXxX(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXxX(msg) then
function Function_XxX(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and DevXxX(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and DevXxX(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","✫: تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevXxX(msg) then
function Function_XxX(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevXxX(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevXxX(msg) then
...
local XxXrt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if XxXrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif XxXrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif XxXrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif XxXrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local XxXrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if XxXrt == "مميز" and Addictive(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✫:  العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'XxX')..') '
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevXxX(msg) then 
...
if text == ("ردود المطور") and DevXxX(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n✫: قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevXxX(msg) then 
send(msg.chat_id_, msg.id_,"✫:  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevXxX(msg) then 
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    not database:get(bot_id .. 'XxX:Lock:ID:Bot' .. msg.chat_id_) then
                    function Function_XxX(extra, result, success)
                        tdcli_function({
                            ID = "GetUser",
...
if text == "تفعيل المغادره" and DevXxX(msg) then   
database:del(bot_id.."Left:Bot"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"✫: تم تفعيل مغادرة البوت") 
return false 
end
if text == "تعطيل المغادره" and DevXxX(msg) then  
...
if database:get(bot_id.."Status:Bc") and not DevXxX(msg) then 
...
if text == "تفعيل الاذاعه" and DevXxX(msg) then  
database:del(bot_id.."Status:Bc") 
send(msg.chat_id_, msg.id_,"\n✫: تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevXxX(msg) then  
...
if text == "تنظيف المشتركين" and DevXxX(msg) then
...
if text == "تنظيف الكروبات" and DevXxX(msg) then
...
if text == ("تحديث السورس") and DevXxX(msg) then  
send(msg.chat_id_,msg.id_,'✫: تم التحديث')
os.execute('rm -rf XxX.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/XxX/main/XxX.lua')
os.execute('wget https://raw.githubusercontent.com/LARICATEAM/XxX/main/start.lua')
dofile('XxX.lua')  
return false
end
if text == "راسلني" then
...
if text == 'السيرفر' and DevXxX(msg) then 
...
if text == 'جلب نسخه احتياطيه' and DevXxX(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if text == 'الملفات' and DevXxX(msg) then
t = '✫: جميع الملفات : \n — — — — — — — — — \n'
i = 0
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
...
if DevXxX(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/XxX-DeV/files_XxX/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevXxX(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/XxX-DeV/files_XxX/main/files_XxX/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevXxX(msg) then
...
if text == "مسح جميع الملفات" and DevXxX(msg) then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"✫: تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevXxX(msg) then
...
if text == 'حذف كليشه المطور' and DevXxX(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'✫:  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevXxX(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevXxX(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and DevXxX(msg) then
dofile("XxX.lua")  
send(msg.chat_id_, msg.id_, "✫: تم التحديث")
end
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevXxX(msg) then
...
if not DevXxX(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if DevXxX(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text and text:match("^- تغير الاشتراك ✫ .$") and DevXxX(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^- تغير رساله الاشتراك ✫ .$") and DevXxX(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✫ ." and DevXxX(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "✫: تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^- تعين قناة الاشتراك ✫ .$") and DevXxX(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '✫: حسنآ ارسل لي معرف القناة')
return false  
end
if text == "- تفعيل الاشتراك الاجباري ✫ ." and DevXxX(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "- تعطيل الاشتراك الاجباري ✫ ." and DevXxX(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "✫: تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "- الاشتراك الاجباري ✫ ." and DevXxX(msg) then  
...
if text == ("قائمه المكتومين العام ✫") and DevXxX(msg) then
local list = database:smembers(bot_id.."GMuted:User")
...
------------------------------------------------------------------------
if text then
local XxX_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if XxX_Msg then    
