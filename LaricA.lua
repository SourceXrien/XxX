...
if hash or DevLaricA(msg) or DevBot(msg) then    
return true    
else    
return false    
end 
...
if hash or DevLaricA(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
if hash or DevLaricA(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevLaricA(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevLaricA(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevLaricA(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
{
{text = '• اشترك الان ⚜️',url="t.me/DevLaricA"},
},
}
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevLaricA(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevLaricA(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text == "اضف رد عام" and DevLaricA(msg) then 
...
if text and DevLaricA(msg) and database:get(bot_id.."LaricA:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
if text and DevLaricA(msg) and database:get(bot_id.."LaricA:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
if text == "مسح رد عام" and DevLaricA(msg) then 
...
if text == "مسح الردود العامه" and DevLaricA(msg) then 
...
if text == 'الردود العامه' and DevLaricA(msg) then
...
if text == "اضف سوال" or text == 'اضف سؤال' or text == 'اضف كت تويت' or text == 'اضف كت' and DevLaricA(msg) then
...
if text == "حذف الاسئله" or text == 'حذف كت تويت' and DevLaricA(msg) then
...
Text = [[
⚜️ • Welcome *to* Source
🔰 • *TeAm* - [”LaricA”](t.me/DevLaricA) 🦁 .
 ••••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••••
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '📑 • TeAM LaricA .',url="https://t.me/DevLaricA/16"},
},
{
...
keyboard.inline_keyboard = {
{
{text = '  معرفة المزيد ؟',url="https://t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if DevLaricA(msg) and AhmeDMember(msg) then
...
keyboard.inline_keyboard = {
{
{text = ' معرفة المزيد ؟',url="t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if not DevLaricA(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if text and text:match("^تغير الاشتراك ♻️$") and DevLaricA(msg) then  
...
if text and DevLaricA(msg) and database:get(bot_id.."LaricA:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendnum..'%',url="https://t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendnuj..'%',url="https://t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = ''..sendnmj..' ‹‹-',url="https://t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = ''..sendnuk..' ‹‹-',url="https://t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendnnk..'%',url="https://t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendzff..'%',url="https://t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendhen..'%',url="https://t.me/DevLaricA"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
