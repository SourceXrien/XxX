...
if hash or Bot(msg) or LaRiCaTeam(msg) or VIP_DeV(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or LaRiCaTeam(msg) or DevBot(msg) or VIP_DeV(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or LaRiCaTeam(msg) or DevBot(msg) or BasicConstructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or LaRiCaTeam(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or LaRiCaTeam(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or VIP_DeV(msg) then        
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  LaRiCaTeam(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or VIP_DeV(msg) then        
return true 
else 
return false 
end 
...
if LaRiCaTeame(user_id) == true then
var = true
elseif LaRiCaTeam(user_id) == true then
var = true
...
if text == ("الثانويين") and LaRiCaTeam(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and LaRiCaTeam(msg) then
function Function_LaricA(extra, result, success)
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and LaRiCaTeam(msg) then
function Function_LaricA(extra, result, success)
...
keyboard.inline_keyboard = {
{
{text = '⏺️| معرفة المزيد ؟',url="t.me/LaRiCaTeam"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
