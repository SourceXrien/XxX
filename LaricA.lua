...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1573309498,1573309498,1573309498}
print([[
...
Reply_Status(msg,msg.sender_user_id_,"lock","💢️┇تم قفـل جميع ")  
return false
end 
...
download_to_file('https://raw.githubusercontent.com/LaricAtele/LaricA/main/LaricA.lua', 'LaricA.lua') 
download_to_file('https://raw.githubusercontent.com/LaricAtele/LaricA/main/start.lua', 'start.lua') 
dofile('LaricA.lua')  
return false
end
