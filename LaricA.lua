...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,157330949888,1573309498,15733094988}
print([[
...
var = "مطور السورس"  
elseif tonumber(user_id) == tonumber(157330949888) then  
var = "مصمم السورس" 
...
{
{text = '🗂️ • Source Files', url="https://t.me/LaRiCaTeam"},
},
{
...
send(msg.chat_id_, msg.id_,'☑️┇ اصدار سورس* لاريكا* لديك (*v1.0*) 🛡️')
end
