...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1573309498,1573309498}
print([[
...
local hash = database:sismember(bot_id.."LaricA:Basic:Constructor23"..msg.chat_id_, msg.sender_user_id_) 
if hash or XvXvJ(msg) or DevBot(msg) then    
return true    
else    
return false    
end 
...
if hash or XvXvJ(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
if hash or XvXvJ(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or XvXvJ(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or XvXvJ(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or XvXvJ(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = "مبرمج السورس"
elseif XvXvJe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."LaricA:Sudo:User", user_id) then
...
local url,res = https.request('http://black-source.tk/BlackTeAM/ChatMember.php?La='..msg.sender_user_id_)
...
{
{text = '• اشترك الان ⚜️',url="t.me/XvXvJ"},
},
}
...
local UserName = (data.username_ or "XvXvJ")
for LaricA in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = LaricA
end
...
function Function_LaricA(arg, data)
msg = arg.msg
if data.id_ then
...
tdcli_function ({ID = "SearchPublicChat",username_ = text},Function_LaricA,{msg=msg})
...
local LaricA_Msg = database:get(bot_id.."LaricA:Add:Filter:Rp2"..text..msg.chat_id_)   
if LaricA_Msg then    
Reply_Status(msg,msg.sender_user_id_,"reply","📬┇"..LaricA_Msg)  
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
if text == "قفل الحمايه" and msg.reply_to_message_id_ == 0 and Constructoryyu(msg) then  
database:set(bot_id.."LaricA:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'LaricA:'..lock..msg.chat_id_,"del")    
end
Reply_Status(msg,msg.sender_user_id_,"lock","♨️┇تم قفـل الحمايه القصوى بنجاح")  
return false
end 
if text == "فتح الحمايه" and msg.reply_to_message_id_ == 0 and Addictive(msg) and ChCheck(msg) then  
database:del(bot_id.."LaricA:Lock:tagservrbot"..msg.chat_id_)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:del(bot_id..'LaricA:'..lock..msg.chat_id_)    
end
Reply_Status(msg,msg.sender_user_id_,"unlock","♨️┇تم فـتح الحمايه القصوى")  
return false
end
--------------------------------------------------------------------------------------------------------------
...
if text == ("مسح قائمه العام") and XvXvJ(msg) then
database:del(bot_id.."LaricA:GBan:User")
send(msg.chat_id_, msg.id_, "\n📮┇تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and XvXvJ(msg) then
...
if text == ("قائمه العام") and XvXvJ(msg) then
...
if text == ("المطورين") and XvXvJ(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and XvXvJ(msg) then
...
if text and text:match("^حظر عام @(.*)$")  and XvXvJ(msg) then
...
if text and text:match("^حظر عام (%d+)$") and XvXvJ(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and XvXvJ(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and XvXvJ(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and XvXvJ(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and XvXvJ(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and XvXvJ(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and XvXvJ(msg) then
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and XvXvJ(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and XvXvJ(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and XvXvJ(msg) then
...
if text == ("تنزيل مالك") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBot(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^تنزيل مالك @(.*)$") and DevBot(msg) and AhmeDMember(msg) then
...
if text == ("مسح الردود المتعدده") and XvXvJ(msg) then
...
if text == ("الردود المتعدده") and XvXvJ(msg) then
...
if text == "اضف رد متعدد" and XvXvJ(msg) then
...
if text == "حذف رد متعدد" and XvXvJ(msg) then
...
if text and text:match("^رفع مالك @(.*)$") and DevBot(msg) and AhmeDMember(msg) then
...
if text == ("رفع منشئ اساسي") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBot(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^رفع منشئ اساسي @(.*)$") and not DevBot(msg) and AhmeDMember(msg) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
...
if text and text:match("^رفع منشئ اساسي (%d+)$") and not DevBot(msg) and AhmeDMember(msg) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
...
if text == ("رفع منشئ اساسي") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructoryyu(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
database:sadd(bot_id.."LaricA:Basic:Constructor"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم ترقيته منشئ اساسي")  
end
...
if text and text:match("^رفع منشئ اساسي @(.*)$") and Constructoryyu(msg) and AhmeDMember(msg) then
local username = text:match("^رفع منشئ اساسي @(.*)$")
function Function_LaricA(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
if text and text:match("^رفع منشئ اساسي (%d+)$") and Constructoryyu(msg) and AhmeDMember(msg) then
local userid = text:match("^رفع منشئ اساسي (%d+)$") 
database:sadd(bot_id.."LaricA:Basic:Constructor"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","💢┇تم ترقيته منشئ اساسي")  
return false
...
if text == "رفع منشئ" and tonumber(msg.reply_to_message_id_) ~= 0 and BasicConstructor(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^رفع منشئ @(.*)$") and BasicConstructor(msg) and AhmeDMember(msg) then
...
------------------------------------------------------------------------
if text and text:match("^رفع منشئ (%d+)$") and BasicConstructor(msg) and AhmeDMember(msg) then
...
if text == ("رفع مدير") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^رفع مدير @(.*)$") and Constructor(msg) and AhmeDMember(msg) then
...
if text and text:match("^رفع مدير (%d+)$") and Constructor(msg) and AhmeDMember(msg) then
local userid = text:match("^رفع مدير (%d+)$") 
database:sadd(bot_id.."LaricA:Manager"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","💢┇تم ترقيته مدير المجموعه")  
return false
end  
if text == ("تنزيل مدير") and tonumber(msg.reply_to_message_id_) ~= 0 and Constructor(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^تنزيل مدير @(.*)$") and Constructor(msg) and AhmeDMember(msg) then
...
if text and text:match("^تنزيل مدير (%d+)$") and Constructor(msg) and AhmeDMember(msg) then
...
if text == ("رفع ادمن") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) and AhmeDMember(msg) then
...
if text and text:match("^رفع ادمن @(.*)$") and Owner(msg) and AhmeDMember(msg) then
...
if text and text:match("^رفع ادمن (%d+)$") and Owner(msg) and AhmeDMember(msg) then
...
if text == ("تنزيل ادمن") and tonumber(msg.reply_to_message_id_) ~= 0 and Owner(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^تنزيل ادمن @(.*)$") and Owner(msg) and AhmeDMember(msg) then
...
if text and text:match("^تنزيل ادمن (%d+)$") and Owner(msg) and AhmeDMember(msg) then
...
if text == ("رفع مميز") and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) and AhmeDMember(msg) then
if not Constructor(msg) and database:get(bot_id.."Add:Group:Cheking"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'✖┇لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المنشئين')
return false
end
...
if text and text:match("^رفع مميز @(.*)$") and Addictive(msg) and AhmeDMember(msg) then
...
if text and text:match("^رفع مميز (%d+)$") and Addictive(msg) and AhmeDMember(msg) then
...
if (text == ("تنزيل مميز")) and tonumber(msg.reply_to_message_id_) ~= 0 and Addictive(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^تنزيل مميز @(.*)$") and Addictive(msg) and AhmeDMember(msg) then
...
if text and text:match("^تنزيل مميز (%d+)$") and Addictive(msg) and AhmeDMember(msg) then
local userid = text:match("^تنزيل مميز (%d+)$") 
database:srem(bot_id.."LaricA:Special:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","💢┇تم تنزيله من المميزين")  
return false
end  
if text and text:match("رفع (.*)") and tonumber(msg.reply_to_message_id_) > 0 and Addictive(msg) and AhmeDMember(msg) then
...
if text and text:match("تنزيل (.*)") and tonumber(msg.reply_to_message_id_) > 0 and Addictive(msg) and AhmeDMember(msg) then
...
if text and text:match("^رفع (.*) @(.*)") and Addictive(msg) and AhmeDMember(msg) then
...
if text and text:match("^تنزيل (.*) @(.*)") and Addictive(msg) and AhmeDMember(msg) then
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, Function_LaricA, nil)
return false
end
------------------------------------------------------------------------
...
local list = database:smembers(bot_id.."LaricA:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."LaricA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LaricA:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."LaricA:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔┇قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local LaricA_Msg = database:get(bot_id.."LaricA:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..LaricA_Msg.."}\n"    
end  
if #list == 0 then  
...
database:set(bot_id.."LaricA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."LaricA:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."LaricA:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
...
database:del(bot_id.."LaricA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."LaricA:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."LaricA:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."LaricA:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:del(bot_id.."LaricA:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."LaricA:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."LaricA:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"ا")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":تغ","تاك للكل")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"تغ")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"تك")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"م")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"اد")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"مد")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"من")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"اس")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"تعط")
database:set(bot_id.."LaricA:Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
database:set(bot_id.."LaricA:List:Cmd:Group:New"..msg.chat_id_,"تفع")
send(msg.chat_id_, msg.id_,"*📮┇تم ترتيب جميع الاوامر التالية ..*\n\n1 • امر الايدي -> ا\n2 • امر تاك للكل -> تغ\n3 • امر رفع مميز -> م\n4 • امر تنزيل الكل -> تك\n5 • امر رفع منشئ -> من\n6 • امر رفع مدير -> مد\n7 • امر رفع منشئ اساسي -> اس\n8 • امر تفعيل الايدي بالصوره -> تفع\n9 • امر تعطيل الايدي بالصوره -> تعط\n\n━━━━━━━━━━━━━\n*📡┇CH @XvXvJ*")  
end
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and XvXvJ(msg) then 
...
if text == ("ردود المطور") and XvXvJ(msg) then 
local list = database:smembers(bot_id.."LaricA:List:Rd:Sudo")
text = "\n⛔┇قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and XvXvJ(msg) then 
send(msg.chat_id_, msg.id_,"📥┇ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."LaricA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and XvXvJ(msg) then 
send(msg.chat_id_, msg.id_,"📫┇ ارسل الكلمه التري تريد حذفها")
...
if database:get(bot_id.."LaricA:admin:Time"..msg.chat_id_) then 
return
 send(msg.chat_id_, msg.id_,"💢️┇انتظر دقيقه من فضلك")
end
database:setex(bot_id.."LaricA:admin:Time"..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == "رتبتي" then
local rtp = database:get(bot_id.."LaricA:Comd:New:rt:User:"..msg.chat_id_..msg.sender_user_id_) or Get_Rank(msg.sender_user_id_,msg.chat_id_)
...
local UserName = (b.username_ or "XvXvJ")
...
---------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------
Namebot = (database:get(bot_id.."LaricA:Name:Bot") or "تويكس")
ArrayRdods = {
"ههـا لاتلح ..",
...
if text == "اضف رد عام" and XvXvJ(msg) then 
database:set(bot_id.."LaricA:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_,true)
database:del(bot_id.."LaricA:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"📥┇  ارسل الكلمه التري تريد اضافتها للرد العام")
return false 
end

if text and XvXvJ(msg) and database:get(bot_id.."LaricA:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_) then
database:del(bot_id.."LaricA:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_)
database:set(bot_id.."LaricA:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_, '📥┇ الان ارسل الرد الذي تريد اضافته للعام \n☑┇ يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
return false
end

if text and XvXvJ(msg) and database:get(bot_id.."LaricA:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_) then
Klma = database:get(bot_id.."LaricA:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_)
Jwab = text
...
if text == "مسح رد عام" and XvXvJ(msg) then 
database:set(bot_id.."LaricA:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"📥┇  ارسل الكلمه التي تريد مسحها للرد العام")
return false 
end


if text == "مسح الردود العامه" and XvXvJ(msg) then 
...
if text == 'الردود العامه' and XvXvJ(msg) then
...
if text == 'تعين الايدي عام' and XvXvJ(msg) then
...
if text == 'حذف الايدي عام' or text == 'مسح الايدي عام' and XvXvJ(msg) then
...
if database:get(bot_id.."LaricA:Status:Bc") and not XvXvJ(msg) then 
...
if text == "تفعيل الاذاعه" and XvXvJ(msg) then  
database:del(bot_id.."LaricA:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n📫┇تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and XvXvJ(msg) then  
...
if text == "اضف سوال" or text == 'اضف سؤال' or text == 'اضف كت تويت' or text == 'اضف كت' and XvXvJ(msg) then
...
if text == "حذف الاسئله" or text == 'حذف كت تويت' and XvXvJ(msg) then
database:del(bot_id.."gamebot:List:Manager")
return send(msg.chat_id_, msg.id_,"☑️┇تم حذف جميع الاسئله")
end
if text and text:match("^(.*)$") then
...
if text == "تنظيف المشتركين" and XvXvJ(msg) then
...
if text == "تنظيف الكروبات" and XvXvJ(msg) then
...
if text == ("تحديث السورس") and XvXvJ(msg) then  
send(msg.chat_id_,msg.id_,'☑┇تم التحديث')
os.execute('rm -rf LaricA.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/XvXvJ/LaricA/master/LaricA.lua', 'LaricA.lua') 
download_to_file('https://raw.githubusercontent.com/XvXvJ/LaricA/master/start.lua', 'start.lua') 
dofile('LaricA.lua')  
return false
end


if text == 'تفعيل البوت الخدمي' and XvXvJ(msg) then  
database:del(bot_id..'LaricA:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and XvXvJ(msg) then  
database:set(bot_id..'LaricA:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and XvXvJ(msg) then
...
if text == 'جلب نسخه احتياطيه' and XvXvJ(msg) then
local list = database:smembers(bot_id..'LaricA:Chek:Groups')  
...
if text == 'الملفات' and XvXvJ(msg) then
t = '☑┇جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls LaricA_Files'):lines() do
if v:match(".lua$") then
...
if XvXvJ(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/LaricAtele/files_LaricA/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and XvXvJ(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/LaricAtele/files_LaricA/master/files_LaricA/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and XvXvJ(msg) then
...
if text == "مسح جميع الملفات" and XvXvJ(msg) then
os.execute("rm -fr LaricA_Files/*")
send(msg.chat_id_,msg.id_,"☑┇تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and XvXvJ(msg) then
...
local list1 = database:smembers('LaricA:'..bot_id..'creatorbasic:'..Groups[i])
for k,v in pairs(list1) do
database:sadd(bot_id.."LaricA:Basic:Constructor"..Groups[i], v)
end
local list2 = database:smembers('LaricA:'..bot_id..'creator:'..Groups[i])
for k,v in pairs(list2) do
database:sadd(bot_id.."LaricA:Constructor"..Groups[i], v)
end
local list3 = database:smembers('LaricA:'..bot_id..'owners:'..Groups[i])
for k,v in pairs(list3) do
database:sadd(bot_id.."LaricA:Manager"..Groups[i], v)
end
local list4 = database:smembers('LaricA:'..bot_id..'mods:'..Groups[i])
for k,v in pairs(list4) do
database:sadd(bot_id.."LaricA:Mod:User"..Groups[i], v)
end
database:set(bot_id.."LaricA:Lock:tagservrbot"..Groups[i],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
database:set(bot_id..'LaricA:'..lock..Groups[i],"del")    
end
end
for i = 1, #Users do
...
if text == 'حذف كليشه المطور' and XvXvJ(msg) then
database:del(bot_id..'LaricA:Text_Dev')
send(msg.chat_id_, msg.id_,'☑┇ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and XvXvJ(msg) then
database:set(bot_id..'LaricA:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📫┇ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'LaricA:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'LaricA:Set:Text_Dev'..msg.chat_id_..':'..msg.sender_user_id_)
...
if text == 'رفع النسخه الاحتياطيه' and XvXvJ(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and XvXvJ(msg) then
dofile("LaricA.lua")  
send(msg.chat_id_, msg.id_, "☑┇تم التحديث")
end
---------------------------------------------------------------------------------------------------------
...
Text = [[
⚜️ • Welcome *to* Source
🔰 • *TeAm* - [”LaricA”](t.me/XvXvJ) 🦁 .
 ••••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••••
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '📑 • TeAM LaricA .',url="https://t.me/XvXvJ/16"},
},
{
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'LaricA:Num:Add:Bot') or 0) and not XvXvJ(msg) then
...
keyboard.inline_keyboard = {
{
{text = '  معرفة المزيد ؟',url="https://t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
database:sadd(bot_id..'LaricA:Basic:Constructor23'..msg.chat_id_, owner_id)
end
end
end,nil)
...
local Text = '☑️┇تم تعطيل المجموعة .'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  معرفة المزيد ؟',url="https://t.me/XvXvJ"},
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'LaricA:Free:Add:Bots') and AhmeDMember(msg) then
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'🚸┇البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
if XvXvJ(msg) and AhmeDMember(msg) then
...
keyboard.inline_keyboard = {
{
{text = ' معرفة المزيد ؟',url="t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if not XvXvJ(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if XvXvJ(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text and text:match("^تغير الاشتراك ♻️$") and XvXvJ(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '📮┇حسنآ ارسل لي معرف القناة') 
return false  
end
if text and text:match("^تغير رساله الاشتراك 📃$") and XvXvJ(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '📮┇حسنآ ارسل لي النص الذي تريده مع معرف القناة') 
return false  
end
if text == "حذف رساله الاشتراك 🚸" and XvXvJ(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "📮┇تم مسح رساله الاشتراك ") 
return false  
end
if text == "تفعيل الاشتراك الاجباري ✅" and XvXvJ(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⛔" and XvXvJ(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "☑┇تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "الاشتراك الاجباري 🚸" and XvXvJ(msg) then  
...
if text == ("قائمة العام 📃") and XvXvJ(msg) then
local list = database:smembers(bot_id.."LaricA:GBan:User")
t = "\n⛔┇قائمة المحظورين عام \n••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉•• \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."LaricA:User:Name" .. v)
...
for k,v in pairs(list) do   
NAME = 'LaricA Chat'
ASAS = database:smembers(bot_id.."LaricA:Basic:Constructoryyu"..v)
MNSH = database:smembers(bot_id.."LaricA:Constructoryyu"..v)
MDER = database:smembers(bot_id.."LaricA:Manager"..v)
MOD = database:smembers(bot_id.."LaricA:Mod:User"..v)
link = database:get(bot_id.."LaricA:Link_Group"..v) or ''
if k == 1 then
...
database:del(bot_id.."LaricA:Link_Group"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."LaricA:Chek:Welcome"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."LaricA:Reply:Sudo"..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'LaricA:Lock:ID:Bot'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id..'LaricA:Lock:ID:Bot:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."LaricA:Kick:Me"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."LaricA:Reply:Manager"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."LaricA:Link_Group"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."LaricA:Chek:Welcome"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."LaricA:Reply:Sudo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'LaricA:Lock:ID:Bot'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id..'LaricA:Lock:ID:Bot:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."LaricA:Kick:Me"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:del(bot_id.."LaricA:Reply:Manager"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homeaddrem"},
...
database:set(bot_id.."LaricA:Lock:AddMempar"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
database:set(bot_id.."LaricA:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:User:Name"..Chat_id,"del") 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Sticker"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Animation"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Video"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Photo"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Audio"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:vico"..Chat_id,"del")    
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Document"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Contact"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Spam"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hset(bot_id.."LaricA:flooding:settings:"..Chat_id ,"flood","del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:set(bot_id.."LaricA:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:AddMempar"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:text"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Join"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Bot:kick"..Chat_id)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:edit"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Link"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Spam"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:hdel(bot_id.."LaricA:flooding:settings:"..Chat_id ,"flood")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id.."LaricA:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data=data.sender_user_id_.."/homelocks"},
...
database:del(bot_id..'LaricA:nwe:mem:group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'\n تم تعطيل تحقق' ) 
end
if text == 'تفعيل تحقق' and Addictive(msg) then  
database:set(bot_id..'LaricA:nwe:mem:group'..msg.chat_id_,'true') 
send(msg.chat_id_, msg.id_,'\nتم تفعيل تحقق' ) 
end 
...
if text and XvXvJ(msg) and database:get(bot_id.."LaricA:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_) then
   database:del(bot_id.."LaricA:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_)
...
if msg.content_.ID == "MessageChatJoinByLink" and database:get(bot_id..'LaricA:nwe:mem:group'..msg.chat_id_) == 'true'then
numphoto = {'3','8','9','6'}
...
local Name_Bot = (database:get(bot_id.."LaricA:Name:Bot") or "تشاكيx")
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendnum..'%',url="https://t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendnuj..'%',url="https://t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = ''..sendnmj..' ‹‹-',url="https://t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = ''..sendnuk..' ‹‹-',url="https://t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendnnk..'%',url="https://t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendzff..'%',url="https://t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '⌁ '..sendhen..'%',url="https://t.me/XvXvJ"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
------------------------------------------------------------------------
if text then
local LaricA_Msg = database:get(bot_id.."LaricA:Add:Filter:Rp2"..text..result.chat_id_)   
if LaricA_Msg then    
Reply_Status(result,result.sender_user_id_,"reply","📬┇"..LaricA_Msg)  
DeleteMessage(result.chat_id_, {[0] = data.message_id_})     
return false
end
end
