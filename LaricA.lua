...
if hash or LaRiCaTeam(msg) then  
return true  
else  
return false  
end  
...
if hash or LaRiCaTeam(msg) or DevBot(msg) then    
return true    
else    
return false    
end 
...
if hash or LaRiCaTeam(msg) or DevBot(msg) or Constructoryyu(msg) then 
return true 
else 
return false 
end 
...
if hash or LaRiCaTeam(msg) or DevBot(msg) or Constructoryyu(msg) or  BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or LaRiCaTeam(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or LaRiCaTeam(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or LaRiCaTeam(msg) or DevBot(msg) or Constructoryyu(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
var = "مبرمج السورس"
elseif LaRiCaTeame(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
elseif database:sismember(bot_id.."LaricA:Sudo:User", user_id) then
...
{
{text = '• اشترك الان ⚜️',url="t.me/LaRiCaTeam"},
},
}
...
if text == ("مسح قائمه العام") and LaRiCaTeam(msg) then
database:del(bot_id.."LaricA:GBan:User")
send(msg.chat_id_, msg.id_, "\n📮┇تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and LaRiCaTeam(msg) then
...
if text == ("قائمه العام") and LaRiCaTeam(msg) then
...
if text == ("المطورين") and LaRiCaTeam(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and LaRiCaTeam(msg) then
...
if text and text:match("^حظر عام @(.*)$")  and LaRiCaTeam(msg) then
...
if text and text:match("^حظر عام (%d+)$") and LaRiCaTeam(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and LaRiCaTeam(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and LaRiCaTeam(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and LaRiCaTeam(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and LaRiCaTeam(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and LaRiCaTeam(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and LaRiCaTeam(msg) then
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and LaRiCaTeam(msg) and AhmeDMember(msg) then
function Function_LaricA(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and LaRiCaTeam(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and LaRiCaTeam(msg) then
...
if text == ("مسح الردود المتعدده") and LaRiCaTeam(msg) then
...
if text == ("الردود المتعدده") and LaRiCaTeam(msg) then
...
if text == "اضف رد متعدد" and LaRiCaTeam(msg) then
...
if text == "حذف رد متعدد" and LaRiCaTeam(msg) then
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and LaRiCaTeam(msg) then 
...
if text == ("ردود المطور") and LaRiCaTeam(msg) then 
local list = database:smembers(bot_id.."LaricA:List:Rd:Sudo")
text = "\n⛔┇قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and LaRiCaTeam(msg) then 
send(msg.chat_id_, msg.id_,"📥┇ ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."LaricA:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and LaRiCaTeam(msg) then 
send(msg.chat_id_, msg.id_,"📫┇ ارسل الكلمه التري تريد حذفها")
...
if text == "اضف رد عام" and LaRiCaTeam(msg) then 
...
if text and LaRiCaTeam(msg) and database:get(bot_id.."LaricA:witt:Rd_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
if text and LaRiCaTeam(msg) and database:get(bot_id.."LaricA:witt:jwab_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
if text == "مسح رد عام" and LaRiCaTeam(msg) then 
...
if text == "مسح الردود العامه" and LaRiCaTeam(msg) then 
...
if text == 'الردود العامه' and LaRiCaTeam(msg) then
...
if database:get(bot_id.."LaricA:Status:Bc") and not LaRiCaTeam(msg) then 
...
if text == "تفعيل الاذاعه" and LaRiCaTeam(msg) then  
database:del(bot_id.."LaricA:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n📫┇تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and LaRiCaTeam(msg) then  
...
if text == "اضف سوال" or text == 'اضف سؤال' or text == 'اضف كت تويت' or text == 'اضف كت' and LaRiCaTeam(msg) then
...
if text == "حذف الاسئله" or text == 'حذف كت تويت' and LaRiCaTeam(msg) then
...
if text == "تنظيف المشتركين" and LaRiCaTeam(msg) then
...
if text == "تنظيف الكروبات" and LaRiCaTeam(msg) then
...
if text == ("تحديث السورس") and LaRiCaTeam(msg) then  
send(msg.chat_id_,msg.id_,'☑┇تم التحديث')
os.execute('rm -rf LaricA.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/LARICATEAM/LaricA/master/LaricA.lua', 'LaricA.lua') 
download_to_file('https://raw.githubusercontent.com/LARICATEAM/LaricA/master/start.lua', 'start.lua') 
dofile('LaricA.lua')  
return false
end


if text == 'تفعيل البوت الخدمي' and LaRiCaTeam(msg) then  
database:del(bot_id..'LaricA:Free:Add:Bots') 
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل البوت الخدمي ') 
end
if text == 'تعطيل البوت الخدمي' and LaRiCaTeam(msg) then  
database:set(bot_id..'LaricA:Free:Add:Bots',true) 
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل البوت الخدمي') 
end
if text and text:match("^تعين عدد الاعضاء (%d+)$") and LaRiCaTeam(msg) then
...
if text == 'جلب نسخه احتياطيه' and LaRiCaTeam(msg) then
local list = database:smembers(bot_id..'LaricA:Chek:Groups')  
...
if text == 'الملفات' and LaRiCaTeam(msg) then
t = '☑┇جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls LaricA_Files'):lines() do
if v:match(".lua$") then
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and LaRiCaTeam(msg) then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and LaRiCaTeam(msg) then
...
if text == "مسح جميع الملفات" and LaRiCaTeam(msg) then
os.execute("rm -fr LaricA_Files/*")
send(msg.chat_id_,msg.id_,"☑┇تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and LaRiCaTeam(msg) then
...
if text == 'حذف كليشه المطور' and LaRiCaTeam(msg) then
database:del(bot_id..'LaricA:Text_Dev')
send(msg.chat_id_, msg.id_,'☑┇ تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and LaRiCaTeam(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and LaRiCaTeam(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
if text == "تحديث" and LaRiCaTeam(msg) then
dofile("LaricA.lua")  
send(msg.chat_id_, msg.id_, "☑┇تم التحديث")
end
---------------------------------------------------------------------------------------------------------
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'LaricA:Num:Add:Bot') or 0) and not LaRiCaTeam(msg) then
...
if LaRiCaTeam(msg) and AhmeDMember(msg) then
...
if not LaRiCaTeam(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') then
...
if LaRiCaTeam(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,'☑┇ اصدار سورس* لاريكا* لديك (*v1.0*) 🛡️')
end
...
if text and text:match("^تغير الاشتراك ♻️$") and LaRiCaTeam(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '📮┇حسنآ ارسل لي معرف القناة') 
return false  
end
if text and text:match("^تغير رساله الاشتراك 📃$") and LaRiCaTeam(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '📮┇حسنآ ارسل لي النص الذي تريده مع معرف القناة') 
return false  
end
if text == "حذف رساله الاشتراك 🚸" and LaRiCaTeam(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "📮┇تم مسح رساله الاشتراك ") 
return false  
end
if text == "تفعيل الاشتراك الاجباري ✅" and LaRiCaTeam(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⛔" and LaRiCaTeam(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "☑┇تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "الاشتراك الاجباري 🚸" and LaRiCaTeam(msg) then  
...
if text == ("قائمة العام 📃") and LaRiCaTeam(msg) then
local list = database:smembers(bot_id.."LaricA:GBan:User")
t = "\n⛔┇قائمة المحظورين عام \n••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉•• \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."LaricA:User:Name" .. v)
...
if text and LaRiCaTeam(msg) and database:get(bot_id.."LaricA:witt:Del_All"..msg.sender_user_id_..":"..msg.chat_id_) then
...
local Name_Bot = (database:get(bot_id.."LaricA:Name:Bot") or "لاريكاx")
